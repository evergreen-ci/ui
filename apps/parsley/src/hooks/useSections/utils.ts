 ...
 * As well as the next section state. If the next state is the same as the current state, the function will return
...
const openSectionContainingLineNumberHelper = ({
  ...
  return [hasDiff, hasDiff ? nextState : sectionState];
};
