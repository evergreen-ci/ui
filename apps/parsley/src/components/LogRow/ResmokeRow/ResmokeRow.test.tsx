...
describe("resmokeRow", () => {
  ...
  it("should apply syntax highlighting to resmoke lines if they have a color", () => {
    ...
    expect(screen.getByTestId("resmoke-row")).toHaveStyle("color: #ff0000");
  });
  it("should highlight text that match a search term", () => {
    ...
    expect(screen.queryByTestId("highlight")).toHaveTextContent("mongod");
  });
