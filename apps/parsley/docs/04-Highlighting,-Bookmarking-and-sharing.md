...
Sharing log lines
To share a particular log line with others, click on the menu icon next to the log line and select "Share line". This will save the line in the URL and highlight the log line. Loading that URL will jump to the linked line.
