...
Sharing log lines
To share a particular log line with others, click the menu icon (⋯) next to the log line and select "Copy share link to selected line". This copies a URL with the line highlighted. Loading that URL will jump to the linked line.
