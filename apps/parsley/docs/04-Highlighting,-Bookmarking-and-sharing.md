...
Bookmarks:
You can bookmark a line by double-clicking on any part of the log line except the menu icon. You can then navigate to your bookmarked lines by clicking on the corresponding line number in the bookmark pane.
...
Sharing log lines
To share a particular log line with others, click on the menu icon next to the log line and select "Copy share link to selected line". This will copy a URL to your clipboard that highlights the linked line when opened. Loading that URL will jump to the linked line.
