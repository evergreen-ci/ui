...
describe("external communications", () => {
  ...
  //   it("handles password fields correctly", () => {
  //     // Test that password fields are properly masked.
  //     const jiraToken = "Personal Access Token";
  //     cy.getInputByLabel(jiraToken).as("jiraTokenInput");
  //     cy.get("@jiraTokenInput").should("have.attr", "type", "password");
  //     cy.get("@jiraTokenInput").type("secret-token");

  //     const slackToken = "Token";
  //     cy.getInputByLabel(slackToken).as("slackTokenInput");
  //     cy.get("@slackTokenInput").should("have.attr", "type", "password");

  //     const splunkToken = "Token";
  //     cy.getInputByLabel(splunkToken).as("splunkTokenInput");
  //     cy.get("@splunkTokenInput").should("have.attr", "type", "password");

  //     const runtimeApiKey = "API Key";
  //     cy.getInputByLabel(runtimeApiKey).as("runtimeApiKeyInput");
  //     cy.get("@runtimeApiKeyInput").should("have.attr", "type", "password");
  //   });

  //   it("can manage chip inputs for Slack fields set", () => {
  //     const slackFieldsSet = "Fields Set";
  //     cy.getInputByLabel(slackFieldsSet).as("slackFieldsSetInput");
  ...
  //     cy.get("@slackFieldsSetInput").type("field1{enter}");
  //     cy.get("@slackFieldsSetInput").type("field2{enter}");
  //     cy.get("@slackFieldsSetInput").type("field3{enter}");

  //     // Verify chips were created.
  //     cy.dataCy("slack").within(() => {
  //       cy.dataCy("filter-chip").should("have.length", 3);
  //       cy.contains("field1").should("exist");
  //       cy.contains("field2").should("exist");
  //       cy.contains("field3").should("exist");
  //     });
  ...
  //       cy.contains("field2")
  //         .parent()
  //         .find('[data-cy="filter-chip-delete"]')
  //         .click();
  //     });
  ...
  //       cy.dataCy("filter-chip").should("have.length", 2);
  //       cy.contains("field1").should("exist");
  //       cy.contains("field2").should("not.exist");
  //       cy.contains("field3").should("exist");
  //     });
  //   });
});
