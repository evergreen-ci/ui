describe("task logs", () => {
  ...
  it("Should link to Parsley, HTML and Raw version of logs", () => {
    ...
    cy.dataCy("raw-log-btn")
      ...
      .and(
        "includes",
        "/task/evergreen_ubuntu1604_test_model_patch_5e823e1f28baeaa22ae00823d83e03082cd148ab_5e4ff3abe3c3317e352062e4_20_02_21_15_13_48/raw-logs?execution=0&origin=system",
      );
  });
