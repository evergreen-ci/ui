...
describe("site banner", () => {
  ...
  it("renders a warning banner", async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByTestId("sitewide-banner-warning")).toBeVisible();
    });
  });
  ...
  it("renders an announcement banner", async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByTestId("sitewide-banner-success")).toBeVisible();
    });
  });
  ...
  it("renders a danger banner", async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByTestId("sitewide-banner-danger")).toBeVisible();
    });
  });
  ...
  it("renders an info banner", async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByTestId("sitewide-banner-info")).toBeVisible();
    });
  });
