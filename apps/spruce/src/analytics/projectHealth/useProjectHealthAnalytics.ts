...
type Action =
  ...
  | { name: "Filtered by build variant"; "filter.type"?: FilterType } // "Variant history" | "Task history" | "Commit chart"
  | { name: "Filtered by requester"; requesters: string[] } // "Commit chart"
  | { name: "Filtered by task"; "filter.type"?: FilterType } // "Commit chart"
