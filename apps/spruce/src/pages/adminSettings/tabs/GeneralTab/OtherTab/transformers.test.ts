...
const expectedForm: OtherFormState = {
  other: {
    ...
    bucketConfig: {
      ...
      logBucketExpirationDays: null,
      logBucketTransitionToIADays: null,
      logBucketTransitionToGlacierDays: null,
      logBucketLifecycleLastSyncedAt: "",
      logBucketLifecycleSyncError: "",
      logBucketLongRetentionName: "logBucketLongRetention",
      logBucketLongRetentionExpirationDays: null,
      logBucketLongRetentionTransitionToIADays: null,
      logBucketLongRetentionTransitionToGlacierDays: null,
      ...
      failedTasksLogBucketExpirationDays: null,
      failedTasksLogBucketTransitionToIADays: null,
      failedTasksLogBucketTransitionToGlacierDays: null,
