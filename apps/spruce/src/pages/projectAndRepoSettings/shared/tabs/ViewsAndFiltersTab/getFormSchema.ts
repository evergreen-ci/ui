...
export const getFormSchema = (
  ...
  uiSchema: {
    ...
    parsleyFilters: {
      ...
      "ui:data-testid": "parsley-filter-list",
      items: (itemData?: { displayTitle?: string }) => ({
        "ui:title": itemData?.displayTitle || "New Parsley Filter",
        "ui:data-testid": "parsley-filter",
        "ui:label": false,
        expression: {
          "ui:widget": "textarea",
          "ui:data-testid": "parsley-filter-expression",
        },
        description: {
          "ui:widget": "textarea",
        },
        caseSensitive: {
          ...
          "ui:data-testid": "parsley-filter-case-sensitivity",
          "ui:sizeVariant": "xsmall",
        },
        exactMatch: {
          "ui:widget": widgets.SegmentedControlWidget,
          "ui:aria-controls": ["exact-match", "inverse-match"],
          "ui:data-testid": "parsley-filter-match-type",
          "ui:sizeVariant": "xsmall",
        },
      }),
    },
