...
export const getFormSchema = (
      ...
      github: {
        ...
        properties: {
          ...
          oldestAllowedMergeBase: {
            ...
            description:
              "Specify the oldest commit SHA on your project branch that is allowed to be a merge base for a PR (optional).",
          },
          prTesting: {
            type: "object" as const,
  ...
  uiSchema: {
    github: {
      ...
      "ui:description": (
        <Description>
          For patches created from GitHub pull requests, Evergreen will schedule
          only the tasks and variants matching the tags/regex definitions. All
          regular expressions must be valid Golang regular expressions. These
          aliases can also be configured in this project’s config YAML if
          Version Control is enabled and no aliases are defined on the project
          or repo page.{" "}
          <StyledLink
