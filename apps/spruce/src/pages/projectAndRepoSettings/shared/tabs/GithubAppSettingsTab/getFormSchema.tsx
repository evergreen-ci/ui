...
export const getFormSchema = ({
  ...
  uiSchema: {
    ...
    tokenPermissionRestrictions: tokenPermissionUISchema(
      identifier,
      defaultsToRepo,
      false,
    ),
...
const tokenPermissionUISchema = (
  identifier: string,
  shouldHide: boolean,
  useRepoDescription: boolean,
) => ({
  ...(shouldHide && { "ui:widget": "hidden" }),
  "ui:ObjectFieldTemplate": CardFieldTemplate,
  "ui:description": useRepoDescription ? (
    <StyledDescription>
      This project is using GitHub app defined in the corresponding repo and is
      inheriting the repo&apos;s token permission restrictions. You must create
    ...
    <StyledDescription>
      ...
      permissions of the Github app by default. Adding further restrictions will
      strengthen the security of your application. You can add restrictions
      either at the{" "}
