...
export type BucketsConfig = {
  ...
  retryFailedLogMoveLookback?: Maybe<Scalars["String"]["output"]>;
...
export type BucketsConfigInput = {
  ...
  retryFailedLogMoveLookback?: InputMaybe<Scalars["String"]["input"]>;
...
export type AdminSettingsQuery = {
  ...
  adminSettings?: {
    ...
    buckets?: {
      ...
      retryFailedLogMoveLookback?: string | null;
