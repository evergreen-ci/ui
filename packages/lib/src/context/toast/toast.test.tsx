...
describe("toast", () => {
  ...
  it("should not display a toast by default", () => {
    ...
    expect(screen.queryByTestId(toastDataTestId)).toBeNull();
  });
  ...
  describe("displays a toast which corresponds to the variant dispatched", () => {
    it("success", async () => {
      ...
      expect(screen.getByTestId(toastDataTestId)).toBeInTheDocument();
  ...
  describe("closing the toast", () => {
    it("should be able to close a toast by clicking the X button by default", async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByTestId(toastDataTestId)).not.toBeInTheDocument();
      });
    });
