 ...
 * returns a React Component which renders the component with the context mocked out.
 * It is meant to be used for testing components that rely on the useToastContext hook. It also exposes
 * some methods to assert that the toast context was called with the correct parameters.
